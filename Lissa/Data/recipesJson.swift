...
class recipesJson {
    ...
    static let recipes: [Recipe] = [
        ...
        Recipe(id: 3, title: "Boerenkool", numberOfPersons: 3, minutes: 35, imageUrl: "https://static.ah.nl/static/recepten/img_006188_890x594_JPG.jpg", ingredients: [Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false)])
    ]
}
