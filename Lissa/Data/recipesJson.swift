...
class recipesJson {
    ...
    """, userName: "Pietje Bell"),
        Recipe(id: 2, title: "Pasta met brocoli", numberOfPersons: 2, minutes: 20, imageUrl: "https://www.lekkerensimpel.com/wp-content/uploads/2015/09/IMG_2877.jpg", ingredients: [Ingredient(title: "Pasta", checked: false), Ingredient(title: "Broccoli", checked: true)], preparationText: "Create a file named Router and place it inside the Service group. We declare a private variable task of type URLSessionTask. This task is essentially what will do all the work. We keep the variable private as we do not want anyone outside this class modifying our task.", userName: "Pietje Bell"),
        Recipe(id: 3, title: "Boerenkool", numberOfPersons: 3, minutes: 35, imageUrl: "https://static.ah.nl/static/recepten/img_006188_890x594_JPG.jpg", ingredients: [Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false), Ingredient(title: "Aardappelen", checked: true), Ingredient(title: "Boerenkool", checked: false)], preparationText: "", userName: "Pietje Bell")
    ]
